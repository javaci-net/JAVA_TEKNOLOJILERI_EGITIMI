...
public class JdbcApp3WithTrxMng {
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			insertRows(stmt); 
			insertRowsWithPreparedStatement(dbConn);
			dbConn.commit();
	...
	private static void insertRowsWithPreparedStatement(Connection dbConn) throws SQLException {
		PreparedStatement stmt = dbConn.prepareStatement("INSERT INTO students VALUES (?,?)");
		stmt.setInt(1, 3);
